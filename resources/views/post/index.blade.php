...
<div class="col-sm-8 blog-main">
            ...
            <div>
                ...
                <div class="blog-post">
                    ...
                    <p class="blog-post-meta">{{$post->created_at->toFormattedDateString()}} <a href="{{asset('/user')}}/{{$post->user->id}}">{{$post->user->name}}</a></p>
                   {!!str_limit($post->content,100,'...') !!}
                    <p class="blog-post-meta">いいね {{$post->zans_count}} | コメント {{$post->comments_count}}</p>
                </div>
                @endforeach
